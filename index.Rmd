...
\
*Unfortunately*, people did not answer faster when the audio was indeed related to the word. So listening to a low-pitched sound prior to seeing the word *thick* or *blunt* did not make people answer faster than when they saw *thin* or *sharp* afterwards. \
\
So participants agreed on *what is the right word* and *what is the wrong word* to describe a high/low-pitched sound. Therefore, **we might be born with all of these various pitch descriptions in our minds**, but we just do not use all of them in our native languages. However, when needed, like in the case of completing an experiment, we can use those words as if they are present in our native language.\
...
\
Taking my finding into consideration, figuring out the *precise* brain mechanisms behind how pitch and our thoughts interact is a puzzle to solve for future researchers!